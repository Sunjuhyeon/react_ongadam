...
function Hd(props) {
    ...
    const scrollingTop = () => {
        ...
        hamMenu && visible ? document.body.classList.add('hamMenu') : document.body.classList.remove('hamMenu')
    }
    useEffect(() => {
                                        ...
                                        v.title.split('|').map((val, idx) => {
                                            return (
                                                <>
                                                    {val}
                                                    {
                                                        idx === 0 && <span className='price ms-1'>{v.em}</span>
                                                    }
                                                </>
                            ...
                            >
                                {
                                    props.info.hddb.navi.map((v, i) => {
                                        return (
                                            <li><Nav.Link href={v.link} >{v.title}</Nav.Link></li>
                                        )
                                    })
                                }
                            </Scrollspy>
